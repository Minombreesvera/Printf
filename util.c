...
/**
 * for_printable - This Evaluates if a char is printable
 * @c: Char to be evaluated.
 *
 * Return: 1 if c is printable, 0 otherwise
 */
int for_printable(char c)
{
	if (c >= 32 && c < 127)
		return (1);
...
/**
 * append_hex_code - This Append ascci in hexadecimal code to buffer
...
/**
 * for_digit - This Verifies if a char is a digit
 * @c: The Char to be evaluated
 *
 * Return: 1 if c is a digit, 0 otherwise
 */
int for_digit(char c)
{
	if (c >= '0' && c <= '9')
		return (1);
